...
public class Student {
	...
	public Student(String sname, String course, String branch, Date dob, float s_marks, float hs_marks, float b_marks,
			float m_marks, String cv_url, String profile_pic, String address, long contact, String email,
			String password) {
		super();
		this.sname = sname;
		this.course = course;
